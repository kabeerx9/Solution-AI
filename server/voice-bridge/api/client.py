...
class NodeAPIClient:
    ...
    async def _request(self, method: str, endpoint: str, 
        ...
        for attempt in range(self.retry_attempts):
            try:
                ...
                logger.error(f"Request timeout (attempt {attempt + 1}/{self.retry_attempts})")
                if attempt < self.retry_attempts - 1:
                    await asyncio.sleep(1)
    ...
    async def process_voice_message(self, call_sid: str, phone_number: str,
                                     transcribed_text: str, 
                                     conversation_context: Optional[dict] = None) -> Optional[dict]:
        """
    ...
    async def check_voice_budget(self, phone_number: str, 
                                  call_duration_estimate: int = 300) -> dict:
        """
    ...
    async def create_voice_conversation(
        ...
        result = await self._request("POST", "/api/agent/create-conversation", data=data)
    ...
    async def save_recording(self, call_sid: str, 
    ...
    async def log_conversation_event(self, call_sid: str, event_type: str,
    ...
    async def request_human_transfer(self, call_sid: str, 
                                      phone_number: str,
